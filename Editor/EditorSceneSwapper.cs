...
namespace editor
{
    public class EditorSceneSwapper : EditorWindow
    {
        ...
        [MenuItem("Tools/Scene Swapper")] // Use `Tools / Quick Actions / Scene Swapper` instead  ? 
        public static void ShowWindow() => EditorWindow.GetWindow< EditorSceneSwapper>( "Scene Swapper" ).minSize = new Vector2( 400, 200 );
        ...
        void OnGUI()
        {
            ...
            else GUILayout.Label("No Items, click + to add");
